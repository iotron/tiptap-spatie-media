...
use Iotronlab\TiptapSpatieMedia\Support\HasTiptapSpatieMediaActionFormSchema;
use Iotronlab\TiptapSpatieMedia\Support\HasTiptapSpatieMediaActionSupport;

class TiptapSpatieMediaAction extends Action
{
    use HasTiptapSpatieMediaActionSupport, HasTiptapSpatieMediaActionFormSchema;
    ...
    protected function setUp(): void
    {
        ...
        $this
            ...
            ->arguments(TiptapSpatieMedia::getTipTapEditorDefaultArguments()) // Default arguments for TipTap editor
